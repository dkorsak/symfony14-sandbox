...
abstract class BasesfGuardRememberKeyQuery extends ModelCriteria
{
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new sfGuardRememberKeyQuery(null, null, $modelAlias);
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(sfGuardRememberKeyPeer::USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(sfGuardRememberKeyPeer::USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
