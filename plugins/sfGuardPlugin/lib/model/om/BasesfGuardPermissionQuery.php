...
abstract class BasesfGuardPermissionQuery extends ModelCriteria
{
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new sfGuardPermissionQuery(null, null, $modelAlias);
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(sfGuardPermissionPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(sfGuardPermissionPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
