...
abstract class BasesfGuardUserProfile extends BaseObject implements Persistent
{
    ...
    public function setSurname($v)
    {
        ...
        if ($this->surname !== $v) {
            $this->surname = $v;
            $this->modifiedColumns[] = sfGuardUserProfilePeer::SURNAME;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(sfGuardUserProfilePeer::SURNAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(sfGuardUserProfilePeer::SURNAME)) $criteria->add(sfGuardUserProfilePeer::SURNAME, $this->surname);
