...
/**
 * Base class that represents a row from the 'static_pages' table.
 *
 *
 *
...
abstract class BaseStaticPage extends BaseObject implements Persistent
{
     ...
     * @return StaticPage The current object (for fluent API support)
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = StaticPagePeer::NAME;
        }
    ...
    public function setIdentifier($v)
    {
        ...
        if ($this->identifier !== $v) {
            $this->identifier = $v;
            $this->modifiedColumns[] = StaticPagePeer::IDENTIFIER;
        }
    ...
    public function setBody($v)
    {
        ...
        if ($this->body !== $v) {
            $this->body = $v;
            $this->modifiedColumns[] = StaticPagePeer::BODY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = StaticPagePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StaticPagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StaticPageQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(StaticPagePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(StaticPagePeer::UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                StaticPagePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StaticPagePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(StaticPagePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(StaticPagePeer::IDENTIFIER)) {
            $modifiedColumns[':p' . $index++]  = '`identifier`';
        }
        if ($this->isColumnModified(StaticPagePeer::BODY)) {
        ...
        $sql = sprintf(
            'INSERT INTO `static_pages` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['StaticPage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StaticPage'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StaticPagePeer::NAME)) $criteria->add(StaticPagePeer::NAME, $this->name);
        if ($this->isColumnModified(StaticPagePeer::IDENTIFIER)) $criteria->add(StaticPagePeer::IDENTIFIER, $this->identifier);
        if ($this->isColumnModified(StaticPagePeer::BODY)) $criteria->add(StaticPagePeer::BODY, $this->body);
     ...
     * objects.
     *
     * @param object $copyObj An object of StaticPage (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StaticPage Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(StaticPagePeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseStaticPage:' . $name))
        {
