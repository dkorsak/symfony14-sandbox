...
abstract class BaseArticle extends BaseObject implements Persistent
{
    ...
    public function setDisplay($v)
    {
        ...
        if ($this->display !== $v) {
            $this->display = $v;
            $this->modifiedColumns[] = ArticlePeer::DISPLAY;
        }
    ...
    public function setSlug($v)
    {
        ...
        if ($this->slug !== $v) {
            $this->slug = $v;
            $this->modifiedColumns[] = ArticlePeer::SLUG;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->display = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($this->isColumnModified(ArticlePeer::SLUG) && $this->getSlug()) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ArticlePeer::UPDATED_AT)) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArticlePeer::DISPLAY)) {
            $modifiedColumns[':p' . $index++]  = '`display`';
        }
        if ($this->isColumnModified(ArticlePeer::SLUG)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticlePeer::DISPLAY)) $criteria->add(ArticlePeer::DISPLAY, $this->display);
        if ($this->isColumnModified(ArticlePeer::SLUG)) $criteria->add(ArticlePeer::SLUG, $this->slug);
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseArticle:' . $name))
        {
