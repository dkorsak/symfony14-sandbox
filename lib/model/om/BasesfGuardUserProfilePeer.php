...
abstract class BasesfGuardUserProfilePeer
{
    ...
    const SURNAME = 'sf_guard_user_profile.surname';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of sfGuardUserProfile objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FirstName', 'Surname', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'firstName', 'surname', ),
        BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID, sfGuardUserProfilePeer::USER_ID, sfGuardUserProfilePeer::FIRST_NAME, sfGuardUserProfilePeer::SURNAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'FIRST_NAME', 'SURNAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'first_name', 'surname', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FirstName' => 2, 'Surname' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'firstName' => 2, 'surname' => 3, ),
        BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID => 0, sfGuardUserProfilePeer::USER_ID => 1, sfGuardUserProfilePeer::FIRST_NAME => 2, sfGuardUserProfilePeer::SURNAME => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'FIRST_NAME' => 2, 'SURNAME' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'first_name' => 2, 'surname' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(sfGuardUserProfilePeer::SURNAME);
        } else {
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (sfGuardUserProfilePeer::$instances as $instance) {
