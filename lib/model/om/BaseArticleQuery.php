 ...
 * @method ArticleQuery orderByBody($order = Criteria::ASC) Order by the body column
 * @method ArticleQuery orderByDisplay($order = Criteria::ASC) Order by the display column
 ...
 * @method ArticleQuery groupByBody() Group by the body column
 * @method ArticleQuery groupByDisplay() Group by the display column
 ...
 * @method Article findOneByBody(string $body) Return the first Article filtered by the body column
 * @method Article findOneByDisplay(boolean $display) Return the first Article filtered by the display column
 ...
 * @method array findByBody(string $body) Return Article objects filtered by the body column
 * @method array findByDisplay(boolean $display) Return Article objects filtered by the display column
...
abstract class BaseArticleQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `title`, `body`, `display`, `slug`, `created_at`, `updated_at` FROM `articles` WHERE `id` = :p0';
        try {
    ...
    public function filterByBody($body = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ArticlePeer::BODY, $body, $comparison);
    }
    ...
    public function filterByDisplay($display = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ArticlePeer::DISPLAY, $display, $comparison);
    }
